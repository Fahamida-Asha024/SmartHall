...
export default function AllComplaints() {
  ...
  const startEdit = (c) => { setEditingId(c.id); setRemarks(c.remarks || ""); setNextStatus(c.status); };
        ...
        <div className="fixed inset-0 bg-gray-900/40 flex items-center justify-center">
          <Card className="w-[420px] p-5">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button onClick={saveEdit} className="text-sm px-4 py-2 bg-gray-900 text-white rounded-lg">Save changes</button>
            </div>
          </Card>
        </div>
      )}
